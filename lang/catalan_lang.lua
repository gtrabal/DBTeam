...
local function run(msg, matches)
	if permissions(msg.from.id, msg.to.id, "lang_install") then
		...
		-- welcome.lua
		set_text(LANG, 'weloff', 'Benvinguda desactivada.')
		set_text(LANG, 'welon', 'Benvinguda activada.')
		set_text(LANG, 'byeon', 'Comiat activat.')
		set_text(LANG, 'byeoff', 'Comiat desactivat.')
		set_text(LANG, 'welcome1', 'Hola ')
		set_text(LANG, 'welcome2', 'Benvingut a ')
		set_text(LANG, 'weldefault', 'La benvinguda activada és la que ve per defecte.')
		set_text(LANG, 'byedefault', 'El comiat activat és el que ve per defecte.')
		set_text(LANG, 'newbye', 'El nou comiat és')
		set_text(LANG, 'bye1', 'Adeu ')
		set_text(LANG, 'bye2', ' Gràcies per la teva visita.')
		set_text(LANG, 'welnew', 'La nova benvinguda guardada és')
